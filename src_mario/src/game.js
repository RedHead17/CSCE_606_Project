...
scene("vaccineInfoScene", ({ level, score }) => {
  ...
  add([
    ...
    add([
      ...
      pos(100, window.innerHeight - 400),
    ]);
...
const playableMap = [
  ...
  [
    ...
    " u                                                                                                                                                                                                                                                                                                                                                                                                                                 ",
    "                                                                                                                                                                                                                                                                                                                                                                                                                                   ",
    "       $$                 ^   $$^^$$^^$$^^$$^^$$^^$$^^$$^^$$^^ $$^^$$^^$$^^ $$^ $$^$$ ^^$$^^$$^^$$^^$$^^$$^^$$^^$$zz   ^^   zz    ^^   zz$$ ^^ zz ^^   zz$$ ^^   zz   ^^$$zz   ^$$ zz  ^ ^   zz   ^^ zz   ^^   zz   ^^    zz   ^^ zz ^  ^ ^   ^     zz   zz   ^^  zzzz         $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$^^zzz$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$zzzz$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$                  () ",
    "===============================================================================================================================================================================================================================================================================================================================================================================================================================-+ ",
  ],
];
...
const info = [
  ...
  [
    "Your child is exposed to thousands of germs every day in his environment. This\nhappens through the food he eats, air he breathes, and things he puts in his mouth.",
  ],
  [
    "Babies are born with immune systems that can fight most germs, but there are some \ndeadly diseases they can’t handle. That’s why they need vaccines to strengthen their immune system.",
  ],
  [
    "Vaccines use very small amounts of antigens to help your child’s immune system \nrecognize and learn to fight serious diseases. Antigens are parts of germs that cause the \nbody’s immune system to go to work.",
  ],

  [
    "Thirty years ago, vaccines used 3,000 antigens to protect against 8 diseases by \nage two. Today, vaccines use 305 antigens to protect against 14 diseases by age two.",
  ],

  [
    "For some vaccines (primarily inactivated vaccines), the first dose does not provide\nas much immunity as possible. So, more than one dose is needed to build more complete \nimmunity. The vaccine that protects against the bacteria Hib, which causes meningitis, \nis a good example.",
  ],
];